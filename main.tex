...
\noindent {\bf High-Resolution Imaging:} High-resolution imaging with milliarcsecond-scale angular resolution using space-based and ground-based adaptive optics will benefit strong lensing, microlensing, and galaxy cluster studies with LSST.
Milliarcsecond-scale angular resolution is needed 

\noindent {\bf Indirect Detection:} By precisely mapping the distribution of dark matter and tracking extreme events, LSST will enable more sensitive searches for energetic particles originating from the dark sector.
